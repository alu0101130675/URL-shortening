    ...
    <main className='m-auto font-bold'>
      ...
      <Search/>
        <div className='bg-gray-100 pt-24 relative -z-40'>
          ...
          <div className='relative flex flex-col sm:flex-row w-5/6 m-auto gap-6 mt-20 mb-20 items-center'>
            <Card 
            ...
            <Card 
              ...
              mt='mt-[52px]'
            />
             <div className='sm:h-2 bg-teal-400 absolute -z-10 sm:top-1/2 sm:w-full h-full w-2 sm:right-0 right-1/2 top-0'/> 
          </div>  
